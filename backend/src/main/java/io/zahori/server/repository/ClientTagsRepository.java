...
public interface ClientTagsRepository extends CrudRepository<ClientTag, Long> {

    /**
     * Find tags set by process id.
     *
     * @param clientId the client id
     * @param processId the process id
     * @return the set
     */
    @Query("SELECT t FROM ClientTag t WHERE t.client.clientId = :clientId and t.process.processId = :processId and t.active = true ORDER BY t.name ASC")
